...
path <- log
load("~/Documents/Work/Code/preprocessing/eutopsQC/data/chrY_names.rda")
load("~/Documents/Work/Code/preprocessing/eutopsQC/data/non_CpG_names.rda")
load("~/Documents/Work/Code/preprocessing/eutopsQC/data/snp_names.rda")
load("~/Documents/Work/Code/preprocessing/eutopsQC/data/zhou_list.rda")
...
log_df$Probe_count <- paste0(nrow(beta_merged), " / ",
                             log_data$n_probes[1],
                             " (", round(nrow(beta_merged)/log_data$n_probes*100, 1), "%)")
